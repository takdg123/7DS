    ...
    <div>
      ...
      {(smallWindow)?<div className="submenu" style={{top: submenuTop}}>
        <ul>
          ...
          <li className="p-2 active"><a href="#">Specification</a></li>
        </ul>
      </div>:null}

      <div className="mx-auto w-full" style={{maxWidth: "1440px", margin:"0 auto", padding: "50px 10vw 0 10vw", background: "#fff", color:"#264256" }}>
